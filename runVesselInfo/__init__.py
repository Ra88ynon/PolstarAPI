...
logging.basicConfig(
    ...
    filename='runVesselInfo.log',  # changed to relative path
    datefmt='%Y-%m-%d %H:%M:%S')
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    for item in positionData['objects']:
        ...
        logger.info('Inserting vessel: ' + vesselInfo['IMONumber'] + ' : ' + vesselInfo['shipName'])
    logger.info('Finished writing vessel Info')
